...
do
    ...
    TASK=topic_key_sentence_extraction
    OUTPUT_DIR=./output/$TASK/ponet-topicExtracitveSum-seed${seed}
...
#    python -m torch.distributed.launch --nproc_per_node $NUM_GPU --master_port $PORT_ID ./src/extractive_summarization/ponet_extractive_summarization.py \
    ...
    python ./src/extractive_summarization/submit_file_generation.py $TASK ${OUTPUT_DIR}/predictions.txt ${OUTPUT_DIR}/submit.json
done
