...
class Wiki50ForDocumentSegmentation(datasets.GeneratorBasedBuilder):
    BUILDER_CONFIGS = [
        DocumentSegmentationConfig(name="Wiki50ForDocumentSegmentation", version=version, description=desc),
    ]
