...
from transformers.models.big_bird.modeling_big_bird import BigBirdPreTrainedModel, BigBirdModel
...
class BigBirdWithDAForSentenceLabelingTopicSegmentation(BigBirdPreTrainedModel):
