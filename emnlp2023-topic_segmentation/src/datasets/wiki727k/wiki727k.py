...
class Wiki727kForDocumentSegmentation(datasets.GeneratorBasedBuilder):
    BUILDER_CONFIGS = [
        DocumentSegmentationConfig(name="Wiki727kForDocumentSegmentation", version=version, description=desc),
    ]
