...
class CnCourseMultiModalityForTopicSegmentation(datasets.GeneratorBasedBuilder):
    BUILDER_CONFIGS = [
        TopicSegmentationConfig(name="CnCourseMultiModalityForTopicSegmentation", version=version, description=desc),
    ]
